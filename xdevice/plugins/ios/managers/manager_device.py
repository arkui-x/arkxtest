...
from ios.environment.dmlib import DeviceConnector
from ios.constants import UsbConst

__all__ = ["ManagerIosDevice"]

LOG = platform_logger("ManagerIosDevice")


@Plugin(type=Plugin.MANAGER, id=ManagerType.ios_device)
class ManagerIosDevice(IDeviceManager, IFilter):
    """
    ...
    def __init__(self):
        ...
        self.support_labels = ["phone", "tablet"]
        self.support_types = ["device_ios", "device"]
        self.wait_times = 0
    ...
    def find_or_create(self, idevice):
        ...
        try:
            ...
            if device is None:
                ...
                device_instance.usb_type = UsbConst.connector_type
    ...
    def list_devices(self):
        ...
        for device in self.devices_list:
            print("{0:<20}{1:<16}{2:<16}{3:<16}{4:<16}{5:<16}{6:<16}".format(
                self.convert_sn(convert_serial(device.device_sn)), device.device_os_type,
